...
export default class LoginAnimation extends Component {
  ...
  moveEyes(phrase) {
    switch (phrase) {
      ...
      case "room":
        return this.setState({ roomClick: !this.state.roomClick });
      default:
        return "nada";
    }
  }
      ...
      <div className="container">
                        ...
                        style={{
                          ...
                          grin: this.state.mouthMovement
                            ? this.state.roomClick
                              ...
                              : spring(20)
                            : spring(50),
                          whistle: this.state.roomClick
                            ? spring(50, { stiffness: 20, damping: 40 })
                            : spring(0),
                          opacity: this.state.roomClick
        ...
        <div id="sign-in-container">
          ...
          <input
            placeholder="room"
            type="room"
            onFocus={() => this.roomClick()}
            onChange={e => this.roomTrack(e)}
            onBlur={() => this.roomClick()}
